...
import {generateSignature, signUrl} from '../src/signing'
...
describe('signUrl', () => {
  ...
  it('should preserve existing query parameters', () => {
    ...
    const signedUrl = signUrl(urlWithParams, options)
    const parsedUrl = new URL(signedUrl)
  ...
  it('should generate different signatures for different keyIds', () => {
    ...
    const signedUrl1 = signUrl(baseUrl, options1)
    const signedUrl2 = signUrl(baseUrl, options2)
